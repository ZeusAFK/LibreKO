...
public static partial class KeyBinds
{
    ...
    private static readonly Entry[] Table =
    {
        ...
        new(KeyAction.Quests, BindGroup.Windows, "Quest Journal", Chord(Key.L)),
        ...
        new(KeyAction.BeautyShop, BindGroup.Windows, "Beauty Shop", Chord(Key.F9)),
        new(KeyAction.Achievements, BindGroup.Windows, "Achievements", Chord(Key.F10)),
        new(KeyAction.Mail, BindGroup.Windows, "Mail", Chord(Key.F11)),
