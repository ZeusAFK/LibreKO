...
public static class TouchControls
{
	...
	public const float InteractButtonOrbit = 1.55f;
	public const float TargetButtonSize = 70f;
	public const float TargetButtonAngle = 242f;
	public const float LootButtonAngle = 326f;
	public const float NpcButtonAngle = 354f;
	public const float AnvilButtonAngle = 270f;
	public const float TeleportButtonAngle = 298f;
